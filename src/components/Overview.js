  ...
  return (
    <div className="Overview">
          ...
          <div className="newMember-div">
              ...
              <p className="id-value" id="newID"  style={{display: 'none'}}>{data.length || 0}.</p>
                      ...
                      data.map((member, index) => (
                                  ...
                                  <form name={`memberForm-${index}`} id={index} className={`member-form-${index} member-formMID-${member.id} member-forms`}>
                                      ...
                                      {/* Member info Form fields */ }
                                        ...
                                        <section id={`infoSection-${index}`} className="member-section-toToggle" style={{display: 'none'}} >
                                            ...
                                            <div className="uniformenTypes-div"> 
                                                ...
                                                <div className="galaLabel-div uniformenLabels-div">
                                                    ...
                                                    <p className="galaP2" title='Bereits ausgegeben?'>aus?</p>
                                                </div>
                                            ...
                                            <div className="uniformenTypes-div"> 
                                                  ...
                                                  <div className="dienstbekleidungLabel-div uniformenLabels-div">
                                                      ...
                                                      <p className="uLabelsP2" title='Bereits ausgegeben?'>aus?</p>
                                                 </div>
          ...
          <div>
                  <a href='https://stefanbartl.github.io/Portfolio/about.html#section-contact'>
                      <img
                          src="https://drive.google.com/uc?export=download&id=1OmTkbqhgmtIeoSiG_5LkwjfSaqRtJ7y1"
                          className="impressumLink"
                          title="Zum technischen Kontakt"
                          alt="Logo des technischen Kontakts"
                      />
                  </a>
          </div>
