...
export default function ToggleDetailedNewMember (back){
  ...
  let toggleState = document.querySelector('.detailMemberToggle').getAttribute('data-visible');
  ...
  if(toggleState === 'false'){
    ...
    toggleConsoleFieldsKeyframes = [
      ...
      // Trigger animations
      document.querySelector('.Detailed-new-Member').animate(toggleConsoleFieldsKeyframes, toggleTiming);
  //#endregion
  
  if(document.querySelector('.detailMemberToggle').getAttribute('data-visible') === 'true'){
    document.querySelector('.detailMemberToggle').setAttribute('data-visible', 'false'); // Toggle data-attribute
  } else {
    document.querySelector('.detailMemberToggle').setAttribute('data-visible', 'true'); 
  };
  ...
  setTimeout(() => {document.querySelector('.detailMemberToggle').style.pointerEvents = 'all';},  animationTime);
